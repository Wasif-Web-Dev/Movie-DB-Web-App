        ...
        <div ref={HcardsRef} className="w-full  flex overflow-y-hidden mb-5">
            {data.map((d, i) => (
                <Link
                    ...
                    key={i}
                    className="overflow-y-auto max-md:min-w-[23%] max-[450px]:min-w-[35%] max-[380px]:min-w-[40%] max-[320px]:h-[45vh] max-md:h-[40vh] max-sm:min-w-[30%] min-w-[16%] h-[35vh] max-sm:mr-2  m-5 bg-zinc-900 mr-5 mb-5 shadow-md shadow-[rgba(0,0,0,0.9)]"
                >
                    <img
