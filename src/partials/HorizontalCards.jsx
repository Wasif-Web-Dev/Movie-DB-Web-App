        ...
        <div ref={HcardsRef} className="w-full  flex overflow-y-hidden mb-5">
            {data.map((d, i) => (
                <Link
                    ...
                    key={i}
                    className="overflow-y-auto max-md:min-w-[23%]  rounded-xl max-[450px]:min-w-[35%] max-[380px]:min-w-[40%] max-[320px]:h-[55vh max-md:h-[40vh] max-mobileL:h-[30vh] max-sm:min-w-[30%] min-w-[16%] h-[35vh] max-sm:mr-2 max-mobileL:m-2 m-5 bg-zinc-900 max-tabletM:bg-transparent mr-5 mb-5 shadow-md shadow-[rgba(0,0,0,0.9)] max-tabletM:overflow-hidden max-tabletM:shadow-none"
                >
                    <img
