    ...
    return (
        <div className="flex items-center justify-start px-[20%] gap-5 h-[10vh] relative z-10">
            ...
            <input
                ...
                value={query}
                className="w-[50%] outline-none border-none bg-transparent text-zinc-300"
                type="text"
            ...
            <div className="rounded-lg max-h-[50vh] overflow-auto bg-zinc-200 w-[40%]  absolute top-[90%]">
                {searches.map((e, i) => (
                    <Link
                        ...
                        className="my-5 hover:text-black hover:font-semibold bg-zinc-200 text-zinc-600 flex justify-start items-center w-[100%] h-[10vh] p-12 border-b-2 border-zinc-100"
                    >
                        <img
