...
const Tvdetails = () => {
    ...
    return info ? (
        <div
            ...
            className="w-screen h-[210vh] max-2xl:h-[220vh] max-Laptop:h-[250vh] max-tabletM:h-[260vh] max-tabletS:h-[365vh] max-mobileL:h-[400vh] bg-[#1F1E24] overflow-hidden px-[10%] max-tabletM:px-[2%]  relative"
        >
            {/* Part 1 nav */}
            ...
            <div className="w-[80%] ">
                <div className="flex flex-col gap-5 mt-8">
                    ...
                    {info.watchProvider && info.watchProvider.rent && (
                        <div className="flex gap-x-10 items-center text-white">
                            <h1 className="text-2xl uppercase">Available for Rent</h1>
